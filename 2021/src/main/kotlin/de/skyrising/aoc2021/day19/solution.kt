...
fun PuzzleInput.part2(): Any? {
    ...
    return scanners.toList().pairs().maxByOrNull { (a, b) -> a.manhattanDistance(b) }?.also(::println)?.let { (a, b) -> a.manhattanDistance(b) }
}
...
private fun parseInput(input: PuzzleInput): List<PointCloud> {
